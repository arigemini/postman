...
# Usage
# ./utils/run_report.sh - Runs it using the normal training files generated
# OR
# ./utils/run_report.sh binary - Converts the training files generated to yes/no and then does training
